...
class LocationController extends GetxController implements GetxService{
  ...
  //whether the user in is service zone or not
  bool _inZone = false;
  ...
  //save the google suggestion for address
  ...
  void updatePosition(CameraPosition position, bool fromAddress) async{
    if(_updateAddressData){
      ...
      try{
        ...
        // if button value false we are in the service area
  ...
  //bug solve pick address map page
  void updatePositionPick(CameraPosition position, bool fromAddress) async{
    if(_updateAddressData){
      _loading = true;
      update();
      try{
